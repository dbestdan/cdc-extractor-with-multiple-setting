	...
	public static void main(String[] args) {
		...
		for (int l = 0; l < noOfSet; l++) {
			...
			for (int i = 1; i <= numberOfExperiment; i++) {
				...
				CoordinatorRunnable coordinator = new CoordinatorRunnable(i, queue, coordinatorSleepDuration,
						sessionEndTime);
				threads.add(new Thread(coordinator));

				System.out.println("Running experiment: " + experiment + ", Coordinator Sleep Duration: "
						+ coordinatorSleepDuration + ", Thread size: " + threadSize + ", Run Duration: " + runDuration);
